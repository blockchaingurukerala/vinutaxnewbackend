...
// //mongoose.connect('mongodb://localhost:27017/magicmathsdb', { useNewUrlParser: true ,useUnifiedTopology: true });
...
//     userPassword : String   
// });
// var AdminData = mongoose.model('admin', NewUserSchema);                        //UserData is the model and NewBookData is the schema
